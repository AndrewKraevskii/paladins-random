...
export const items: { en: Item[] } = {
	en: [
		...
		},
		{
			name: 'Guardian',
			incompatible_champions: [
				2147, 2551, 2549, 2548, 2205, 2512, 2550, 2541, 2285, 2480, 2393, 2536, 2254, 2093, 2431,
				2420, 2495, 2277, 2094, 2509, 2348, 2267, 2517, 2249, 2493, 2281, 2092, 2362, 2417, 2338,
				2481, 2303, 2540, 2056, 2528, 2542, 2543, 2372, 2057, 2438, 2314, 2472, 2529, 2491, 2307
			],
